...
DATASET_PATH = "/home/matheus/Documents/Dissertacao-Dev/spectrograms_dataset_full.h5"
DATASET_FPATH = "/home/matheus/Documents/Dissertacao-Dev/factors_full.h5"
WMF_FEATURES = '/home/matheus/Documents/Dissertacao-Dev/testefull.npz'
NEW_USERS2 = '/home/matheus/Documents/Dissertacao-Dev/newusers2.pkl'

d = h5py.File(DATASET_PATH, 'r')
dfs = h5py.File(DATASET_FPATH, 'r')

print "2- TREINO DA FUNCAO OBJETIVO 2 COM CRIACAO DE USUARIOS"
...
all_ids = all_ids[list_index_not_cold]
...
def objective_ratings(layers, loss_function, target, users, sumall, aggregate=aggregate, deterministic=False, get_output_kw=None):
    ...
    loss = loss * 0.000000001

    return loss

print "Modelo2- Treino da CNN no dataset completo - funcao objetivo 2"
...
for j in xrange(13):
    ...
    itvec = list(range((num_examples + batchsize - 1) // batchsize))
